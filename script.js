...
async function generateSummary() {
    try {
        ...
        const response = await fetch("https://smart-prep-sxdk.onrender.com/api/generate-summary", {
            method: "POST",
            headers: {
...
async function handleTopicClick(topic, subject) {
    try {
        ...
        try {
            const healthCheck = await fetch("https://smart-prep-sxdk.onrender.com/health");
            if (!healthCheck.ok) {
        ...
        let response;
        try {
            response = await fetch("https://smart-prep-sxdk.onrender.com/api/get-chapter-content", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
...
async function generateMCQs() {
    try {
        ...
        const response = await fetch('https://smart-prep-sxdk.onrender.com/api/generate-mcq', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
        ...
        const questionsArray = mcqData.questions.split('\n\n')
            ...
            .map(questionBlock => {
                ...
                const correctAnswer = options.find(opt => opt.includes('✓'))?.replace(' ✓', '') || options[0];
...
async function fetchAndRedirect() {
    ...
    try {
        const response = await fetch(`https://smart-prep-sxdk.onrender.com/get-subjects?state=${state}&curriculum=${curriculum}&grade=${grade}`);
...
async function fetchTopics(subject) {
    try {
        ...
        const response = await fetch(`https://smart-prep-sxdk.onrender.com/get-topics?${new URLSearchParams({
